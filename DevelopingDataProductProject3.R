...
sidebar <- dashboardSidebar(
  ...
  sidebarMenu(
    ...
    menuItem("Developing Data Project3", icon = icon("file-code-o"),
             href = "https://github.com/Saydaliev/DevelopingDataProduct"
    )
  )
)
  ...
  tabItems(
    tabItem("dashboard",
            ...
            fluidRow(
              ...
              # ),
              box(
                title = "Enter Stock Code From Yahoo Finance", width = 4, solidHeader = TRUE, status = "primary",
...
messages <- dropdownMenu(type = "messages",
                         ...
                         messageItem(
                           from = "Yahoo Finance",
                           message = "Yahoo Finance ?",
                           icon = icon("question"),
                           time = "13:45"
                         ),
                         messageItem(
                           from = "Support",
                           message = "Developing Data Product.",
                           icon = icon("life-ring"),
                           time = "2020-04-04"
                         )
)
